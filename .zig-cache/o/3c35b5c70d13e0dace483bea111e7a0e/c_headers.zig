...
pub const struct__IO_marker = opaque {}; // /snap/zig/16206/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:75:7: warning: struct demoted to opaque type - has bitfield
...
const enum_unnamed_4 = c_uint; // /snap/zig/16206/lib/libc/include/any-linux-any/linux/bpf.h:82:7: warning: struct demoted to opaque type - has bitfield
...
pub const BPF_CGROUP_ITER_CHILDREN: c_int = 5;
...
pub const BPF_PROG_ASSOC_STRUCT_OPS: c_int = 38;
pub const __MAX_BPF_CMD: c_int = 39;
...
pub const BPF_MAP_TYPE_INSN_ARRAY: c_int = 34;
pub const __MAX_BPF_MAP_TYPE: c_int = 35;
...
pub const BPF_TRACE_FSESSION: c_int = 58;
pub const __MAX_BPF_ATTACH_TYPE: c_int = 59;
...
pub const BPF_F_CPU: c_int = 8;
pub const BPF_F_ALL_CPUS: c_int = 16;
...
pub const BPF_F_RB_OVERWRITE: c_int = 524288;
...
const struct_unnamed_15 = extern struct {
    ...
    excl_prog_hash: __u64 = 0,
    excl_prog_hash_size: __u32 = 0,
};
...
const union_unnamed_31 = extern union {
    prog_cnt: __u32,
    count: __u32,
}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
const struct_unnamed_29 = opaque {}; // /snap/zig/16206/lib/libc/include/any-linux-any/linux/bpf.h:1745:4: warning: union demoted to opaque type - has opaque field
pub const union_bpf_attr = opaque {};
...
pub const BPF_RB_OVERWRITE_POS: c_int = 4;
...
pub const struct_bpf_flow_keys = extern struct {
    ...
    sport: __be16 = 0,
    dport: __be16 = 0,
    unnamed_0: union_unnamed_55 = @import("std").mem.zeroes(union_unnamed_55),
    flags: __u32 = 0,
    flow_label: __be32 = 0,
}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: union demoted to opaque type - has bitfield
const union_unnamed_54 = opaque {}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has opaque field
...
pub const struct_bpf_tunnel_key = extern struct {
    ...
    tunnel_tos: __u8 = 0,
    tunnel_ttl: __u8 = 0,
    unnamed_1: union_unnamed_59 = @import("std").mem.zeroes(union_unnamed_59),
    tunnel_label: __u32 = 0,
    unnamed_2: union_unnamed_60 = @import("std").mem.zeroes(union_unnamed_60),
};
...
pub const enum_bpf_ret_code = c_uint; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
...
const union_unnamed_62 = extern union {
    ipv4: struct_unnamed_63,
    ipv6: struct_unnamed_64,
};
...
pub const struct_bpf_devmap_val = extern struct {
    ifindex: __u32 = 0,
    bpf_prog: union_unnamed_65 = @import("std").mem.zeroes(union_unnamed_65),
};
...
pub const struct_bpf_cpumap_val = extern struct {
    qsize: __u32 = 0,
    bpf_prog: union_unnamed_66 = @import("std").mem.zeroes(union_unnamed_66),
};
pub const SK_DROP: c_int = 0;
pub const SK_PASS: c_int = 1;
pub const enum_sk_action = c_uint; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: union demoted to opaque type - has bitfield
const union_unnamed_67 = opaque {}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has opaque field
pub const struct_sk_msg_md = opaque {}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: union demoted to opaque type - has bitfield
const union_unnamed_68 = opaque {}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has opaque field
pub const struct_sk_reuseport_md = opaque {}; // /snap/zig/16206/lib/libc/include/any-linux-any/linux/bpf.h:6673:8: warning: struct demoted to opaque type - has bitfield
...
const struct_unnamed_70 = opaque {}; // /snap/zig/16206/lib/libc/include/any-linux-any/linux/bpf.h:6741:5: warning: union demoted to opaque type - has opaque field
const union_unnamed_69 = opaque {}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has opaque field
pub const struct_bpf_link_info = opaque {};
...
const union_unnamed_71 = opaque {}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has opaque field
pub const struct_bpf_sock_addr = opaque {};
const union_unnamed_72 = extern union {
    args: [4]__u32,
    reply: __u32,
    replylong: [4]__u32,
}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: union demoted to opaque type - has bitfield
const union_unnamed_73 = opaque {}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has opaque field
pub const struct_bpf_sock_ops = opaque {};
...
pub const SK_BPF_BYPASS_PROT_MEM: c_int = 1010;
...
pub const struct_bpf_raw_tracepoint_args = extern struct {
    ...
    pub fn args(_self: anytype) __helpers.FlexibleArrayType(@TypeOf(_self), @typeInfo(@TypeOf(_self.*._args)).array.child) {
        return @ptrCast(@alignCast(&_self.*._args));
    }
};
...
pub const struct_bpf_fib_lookup = extern struct {
    ...
    sport: __be16 = 0,
    dport: __be16 = 0,
    unnamed_0: union_unnamed_85 = @import("std").mem.zeroes(union_unnamed_85),
    ifindex: __u32 = 0,
    unnamed_1: union_unnamed_86 = @import("std").mem.zeroes(union_unnamed_86),
    unnamed_2: union_unnamed_87 = @import("std").mem.zeroes(union_unnamed_87),
    unnamed_3: union_unnamed_88 = @import("std").mem.zeroes(union_unnamed_88),
    unnamed_4: union_unnamed_89 = @import("std").mem.zeroes(union_unnamed_89),
    unnamed_5: union_unnamed_91 = @import("std").mem.zeroes(union_unnamed_91),
};
...
pub const struct_bpf_task_work = extern struct {
    __opaque: __u64 = 0,
};
...
const union_unnamed_96 = opaque {}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has opaque field
pub const struct_bpf_sockopt = opaque {};
pub const struct_bpf_pidns_info = extern struct {
    pid: __u32 = 0,
    tgid: __u32 = 0,
}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: union demoted to opaque type - has bitfield
const union_unnamed_98 = opaque {}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: union demoted to opaque type - has opaque field
const union_unnamed_97 = opaque {}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has opaque field
...
pub const enum_bpf_kfunc_flags = c_uint; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
pub const struct_bpf_insn_array_value = opaque {};
...
pub const struct___locale_data_101 = opaque {};
pub const struct___locale_struct = extern struct {
    __locales: [13]?*struct___locale_data_101 = @import("std").mem.zeroes([13]?*struct___locale_data_101),
...
pub const struct_bpf_program = opaque {
    ...
    pub const bpf_program__set_ifindex = __root.bpf_program__set_ifindex;
    ...
    pub const bpf_program__set_autoload = __root.bpf_program__set_autoload;
    pub const bpf_program__autoattach = __root.bpf_program__autoattach;
    pub const bpf_program__set_autoattach = __root.bpf_program__set_autoattach;
    pub const bpf_program__insns = __root.bpf_program__insns;
    pub const bpf_program__set_insns = __root.bpf_program__set_insns;
    pub const bpf_program__insn_cnt = __root.bpf_program__insn_cnt;
    pub const bpf_program__fd = __root.bpf_program__fd;
    pub const bpf_program__pin = __root.bpf_program__pin;
    pub const bpf_program__unpin = __root.bpf_program__unpin;
    pub const bpf_program__unload = __root.bpf_program__unload;
    ...
    pub const bpf_program__set_type = __root.bpf_program__set_type;
    pub const bpf_program__expected_attach_type = __root.bpf_program__expected_attach_type;
    pub const bpf_program__set_expected_attach_type = __root.bpf_program__set_expected_attach_type;
    pub const bpf_program__flags = __root.bpf_program__flags;
    pub const bpf_program__set_flags = __root.bpf_program__set_flags;
    pub const bpf_program__log_level = __root.bpf_program__log_level;
    pub const bpf_program__set_log_level = __root.bpf_program__set_log_level;
    pub const bpf_program__log_buf = __root.bpf_program__log_buf;
    pub const bpf_program__set_log_buf = __root.bpf_program__set_log_buf;
    pub const bpf_program__set_attach_target = __root.bpf_program__set_attach_target;
    pub const get_type = __root.bpf_program__get_type;
    pub const get_expected_attach_type = __root.bpf_program__get_expected_attach_type;
    pub const set_ifindex = __root.bpf_program__set_ifindex;
    pub const name = __root.bpf_program__name;
    pub const section_name = __root.bpf_program__section_name;
    pub const autoload = __root.bpf_program__autoload;
    pub const set_autoload = __root.bpf_program__set_autoload;
    pub const autoattach = __root.bpf_program__autoattach;
    pub const set_autoattach = __root.bpf_program__set_autoattach;
    pub const insns = __root.bpf_program__insns;
    pub const set_insns = __root.bpf_program__set_insns;
    pub const insn_cnt = __root.bpf_program__insn_cnt;
    pub const fd = __root.bpf_program__fd;
    pub const pin = __root.bpf_program__pin;
    pub const unpin = __root.bpf_program__unpin;
    pub const unload = __root.bpf_program__unload;
    pub const attach = __root.bpf_program__attach;
    pub const attach_perf_event = __root.bpf_program__attach_perf_event;
    pub const attach_perf_event_opts = __root.bpf_program__attach_perf_event_opts;
    pub const attach_kprobe = __root.bpf_program__attach_kprobe;
    pub const attach_kprobe_opts = __root.bpf_program__attach_kprobe_opts;
    pub const attach_kprobe_multi_opts = __root.bpf_program__attach_kprobe_multi_opts;
    pub const attach_uprobe_multi = __root.bpf_program__attach_uprobe_multi;
    pub const attach_ksyscall = __root.bpf_program__attach_ksyscall;
    pub const attach_uprobe = __root.bpf_program__attach_uprobe;
    pub const attach_uprobe_opts = __root.bpf_program__attach_uprobe_opts;
    pub const attach_usdt = __root.bpf_program__attach_usdt;
    pub const attach_tracepoint = __root.bpf_program__attach_tracepoint;
    pub const attach_tracepoint_opts = __root.bpf_program__attach_tracepoint_opts;
    pub const attach_raw_tracepoint = __root.bpf_program__attach_raw_tracepoint;
    pub const attach_trace = __root.bpf_program__attach_trace;
    pub const attach_trace_opts = __root.bpf_program__attach_trace_opts;
    pub const attach_lsm = __root.bpf_program__attach_lsm;
    pub const attach_cgroup = __root.bpf_program__attach_cgroup;
    pub const attach_netns = __root.bpf_program__attach_netns;
    pub const attach_xdp = __root.bpf_program__attach_xdp;
    pub const attach_freplace = __root.bpf_program__attach_freplace;
    pub const attach_netfilter = __root.bpf_program__attach_netfilter;
    pub const attach_tcx = __root.bpf_program__attach_tcx;
    pub const attach_netkit = __root.bpf_program__attach_netkit;
    pub const attach_iter = __root.bpf_program__attach_iter;
    pub const @"type" = __root.bpf_program__type;
    pub const set_type = __root.bpf_program__set_type;
    pub const expected_attach_type = __root.bpf_program__expected_attach_type;
    pub const set_expected_attach_type = __root.bpf_program__set_expected_attach_type;
    pub const flags = __root.bpf_program__flags;
    pub const set_flags = __root.bpf_program__set_flags;
    pub const log_level = __root.bpf_program__log_level;
    pub const set_log_level = __root.bpf_program__set_log_level;
    pub const log_buf = __root.bpf_program__log_buf;
    pub const set_log_buf = __root.bpf_program__set_log_buf;
    pub const set_attach_target = __root.bpf_program__set_attach_target;
};
pub const struct_bpf_map = opaque {
    ...
    pub const bpf_map__set_autocreate = __root.bpf_map__set_autocreate;
    pub const bpf_map__autocreate = __root.bpf_map__autocreate;
    pub const bpf_map__fd = __root.bpf_map__fd;
    pub const bpf_map__reuse_fd = __root.bpf_map__reuse_fd;
    pub const bpf_map__name = __root.bpf_map__name;
    pub const bpf_map__type = __root.bpf_map__type;
    pub const bpf_map__set_type = __root.bpf_map__set_type;
    pub const bpf_map__max_entries = __root.bpf_map__max_entries;
    pub const bpf_map__set_max_entries = __root.bpf_map__set_max_entries;
    pub const bpf_map__map_flags = __root.bpf_map__map_flags;
    pub const bpf_map__set_map_flags = __root.bpf_map__set_map_flags;
    pub const bpf_map__numa_node = __root.bpf_map__numa_node;
    pub const bpf_map__set_numa_node = __root.bpf_map__set_numa_node;
    pub const bpf_map__key_size = __root.bpf_map__key_size;
    pub const bpf_map__set_key_size = __root.bpf_map__set_key_size;
    pub const bpf_map__value_size = __root.bpf_map__value_size;
    pub const bpf_map__set_value_size = __root.bpf_map__set_value_size;
    ...
    pub const bpf_map__set_ifindex = __root.bpf_map__set_ifindex;
    pub const bpf_map__map_extra = __root.bpf_map__map_extra;
    pub const bpf_map__set_map_extra = __root.bpf_map__set_map_extra;
    pub const bpf_map__set_initial_value = __root.bpf_map__set_initial_value;
    pub const bpf_map__initial_value = __root.bpf_map__initial_value;
    pub const bpf_map__is_internal = __root.bpf_map__is_internal;
    pub const bpf_map__set_pin_path = __root.bpf_map__set_pin_path;
    pub const bpf_map__pin_path = __root.bpf_map__pin_path;
    pub const bpf_map__is_pinned = __root.bpf_map__is_pinned;
    pub const bpf_map__pin = __root.bpf_map__pin;
    pub const bpf_map__unpin = __root.bpf_map__unpin;
    pub const bpf_map__set_inner_map_fd = __root.bpf_map__set_inner_map_fd;
    pub const bpf_map__inner_map = __root.bpf_map__inner_map;
    ...
    pub const get_pin_path = __root.bpf_map__get_pin_path;
    pub const attach_struct_ops = __root.bpf_map__attach_struct_ops;
    pub const set_autocreate = __root.bpf_map__set_autocreate;
    pub const autocreate = __root.bpf_map__autocreate;
    pub const fd = __root.bpf_map__fd;
    pub const reuse_fd = __root.bpf_map__reuse_fd;
    pub const name = __root.bpf_map__name;
    pub const @"type" = __root.bpf_map__type;
    pub const set_type = __root.bpf_map__set_type;
    pub const max_entries = __root.bpf_map__max_entries;
    pub const set_max_entries = __root.bpf_map__set_max_entries;
    pub const map_flags = __root.bpf_map__map_flags;
    pub const set_map_flags = __root.bpf_map__set_map_flags;
    pub const numa_node = __root.bpf_map__numa_node;
    pub const set_numa_node = __root.bpf_map__set_numa_node;
    pub const key_size = __root.bpf_map__key_size;
    pub const set_key_size = __root.bpf_map__set_key_size;
    pub const value_size = __root.bpf_map__value_size;
    pub const set_value_size = __root.bpf_map__set_value_size;
    pub const btf_key_type_id = __root.bpf_map__btf_key_type_id;
    pub const btf_value_type_id = __root.bpf_map__btf_value_type_id;
    pub const ifindex = __root.bpf_map__ifindex;
    pub const set_ifindex = __root.bpf_map__set_ifindex;
    pub const map_extra = __root.bpf_map__map_extra;
    pub const set_map_extra = __root.bpf_map__set_map_extra;
    pub const set_initial_value = __root.bpf_map__set_initial_value;
    pub const initial_value = __root.bpf_map__initial_value;
    pub const is_internal = __root.bpf_map__is_internal;
    pub const set_pin_path = __root.bpf_map__set_pin_path;
    pub const pin_path = __root.bpf_map__pin_path;
    pub const is_pinned = __root.bpf_map__is_pinned;
    pub const pin = __root.bpf_map__pin;
    pub const unpin = __root.bpf_map__unpin;
    pub const set_inner_map_fd = __root.bpf_map__set_inner_map_fd;
    pub const inner_map = __root.bpf_map__inner_map;
    pub const lookup_elem = __root.bpf_map__lookup_elem;
    pub const update_elem = __root.bpf_map__update_elem;
    pub const delete_elem = __root.bpf_map__delete_elem;
    pub const lookup_and_delete_elem = __root.bpf_map__lookup_and_delete_elem;
    pub const get_next_key = __root.bpf_map__get_next_key;
};
pub const struct_btf = opaque {
    pub const btf__get_raw_data = __root.btf__get_raw_data;
    pub const get_raw_data = __root.btf__get_raw_data;
};
pub const struct_btf_ext = opaque {
    pub const btf_ext__get_raw_data = __root.btf_ext__get_raw_data;
    pub const get_raw_data = __root.btf_ext__get_raw_data;
};
...
pub const struct_bpf_object = opaque {
    ...
    pub const bpf_object__name = __root.bpf_object__name;
    pub const bpf_object__kversion = __root.bpf_object__kversion;
    pub const bpf_object__set_kversion = __root.bpf_object__set_kversion;
    pub const bpf_object__btf = __root.bpf_object__btf;
    pub const bpf_object__btf_fd = __root.bpf_object__btf_fd;
    pub const bpf_object__find_program_by_name = __root.bpf_object__find_program_by_name;
    pub const bpf_object__next_program = __root.bpf_object__next_program;
    pub const bpf_object__prev_program = __root.bpf_object__prev_program;
    pub const bpf_object__find_map_by_name = __root.bpf_object__find_map_by_name;
    pub const bpf_object__find_map_fd_by_name = __root.bpf_object__find_map_fd_by_name;
    pub const bpf_object__next_map = __root.bpf_object__next_map;
    pub const bpf_object__prev_map = __root.bpf_object__prev_map;
    ...
    pub const pin_maps = __root.bpf_object__pin_maps;
    pub const unpin_maps = __root.bpf_object__unpin_maps;
    pub const pin_programs = __root.bpf_object__pin_programs;
    pub const unpin_programs = __root.bpf_object__unpin_programs;
    pub const pin = __root.bpf_object__pin;
    pub const unpin = __root.bpf_object__unpin;
    pub const name = __root.bpf_object__name;
    pub const kversion = __root.bpf_object__kversion;
    pub const set_kversion = __root.bpf_object__set_kversion;
    pub const btf_fd = __root.bpf_object__btf_fd;
    pub const find_program_by_name = __root.bpf_object__find_program_by_name;
    pub const next_program = __root.bpf_object__next_program;
    pub const prev_program = __root.bpf_object__prev_program;
    pub const find_map_by_name = __root.bpf_object__find_map_by_name;
    pub const find_map_fd_by_name = __root.bpf_object__find_map_fd_by_name;
    pub const next_map = __root.bpf_object__next_map;
    pub const prev_map = __root.bpf_object__prev_map;
    pub const gen_loader = __root.bpf_object__gen_loader;
}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
...
pub const struct_bpf_link = opaque {
    pub const bpf_link__fd = __root.bpf_link__fd;
    pub const bpf_link__pin_path = __root.bpf_link__pin_path;
    ...
    pub const fd = __root.bpf_link__fd;
    pub const pin_path = __root.bpf_link__pin_path;
    pub const pin = __root.bpf_link__pin;
    pub const unpin = __root.bpf_link__unpin;
    pub const update_program = __root.bpf_link__update_program;
    ...
    pub const update_map = __root.bpf_link__update_map;
};
...
pub extern fn bpf_program__attach(prog: ?*const struct_bpf_program) ?*struct_bpf_link; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
...
pub const enum_probe_attach_mode = c_uint; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
...
pub extern fn bpf_program__attach_kprobe_opts(prog: ?*const struct_bpf_program, func_name: [*c]const u8, opts: ?*const struct_bpf_kprobe_opts) ?*struct_bpf_link; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
pub const struct_bpf_kprobe_multi_opts = opaque {};
pub extern fn bpf_program__attach_kprobe_multi_opts(prog: ?*const struct_bpf_program, pattern: [*c]const u8, opts: ?*const struct_bpf_kprobe_multi_opts) ?*struct_bpf_link; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
pub const struct_bpf_uprobe_multi_opts = opaque {};
pub extern fn bpf_program__attach_uprobe_multi(prog: ?*const struct_bpf_program, pid: pid_t, binary_path: [*c]const u8, func_pattern: [*c]const u8, opts: ?*const struct_bpf_uprobe_multi_opts) ?*struct_bpf_link; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
pub const struct_bpf_ksyscall_opts = opaque {};
pub extern fn bpf_program__attach_ksyscall(prog: ?*const struct_bpf_program, syscall_name: [*c]const u8, opts: ?*const struct_bpf_ksyscall_opts) ?*struct_bpf_link; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
...
pub extern fn bpf_program__attach_uprobe_opts(prog: ?*const struct_bpf_program, pid: pid_t, binary_path: [*c]const u8, func_offset: usize, opts: ?*const struct_bpf_uprobe_opts) ?*struct_bpf_link; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
...
pub extern fn bpf_program__attach_netfilter(prog: ?*const struct_bpf_program, opts: [*c]const struct_bpf_netfilter_opts) ?*struct_bpf_link; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
pub const struct_bpf_tcx_opts = opaque {};
pub extern fn bpf_program__attach_tcx(prog: ?*const struct_bpf_program, ifindex: c_int, opts: ?*const struct_bpf_tcx_opts) ?*struct_bpf_link; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
...
pub extern fn bpf_map__get_next_key(map: ?*const struct_bpf_map, cur_key: ?*const anyopaque, next_key: ?*anyopaque, key_sz: usize) c_int; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
pub const struct_bpf_xdp_set_link_opts = opaque {}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
pub const struct_bpf_xdp_attach_opts = opaque {}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
...
pub const enum_bpf_tc_flags = c_uint; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
pub const struct_bpf_tc_hook = opaque {
    ...
    pub const bpf_tc_attach = __root.bpf_tc_attach;
    pub const bpf_tc_detach = __root.bpf_tc_detach;
    pub const bpf_tc_query = __root.bpf_tc_query;
    pub const create = __root.bpf_tc_hook_create;
    pub const destroy = __root.bpf_tc_hook_destroy;
    pub const attach = __root.bpf_tc_attach;
    pub const detach = __root.bpf_tc_detach;
    pub const query = __root.bpf_tc_query;
}; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
...
pub const struct_ring_buffer = opaque {
    ...
    pub const ring_buffer__epoll_fd = __root.ring_buffer__epoll_fd;
    ...
    pub const epoll_fd = __root.ring_buffer__epoll_fd;
};
pub const struct_ring = opaque {
    pub const ring__consumer_pos = __root.ring__consumer_pos;
    pub const ring__producer_pos = __root.ring__producer_pos;
    pub const ring__avail_data_size = __root.ring__avail_data_size;
    pub const ring__size = __root.ring__size;
    pub const ring__map_fd = __root.ring__map_fd;
    pub const ring__consume = __root.ring__consume;
    pub const consumer_pos = __root.ring__consumer_pos;
    pub const producer_pos = __root.ring__producer_pos;
    pub const avail_data_size = __root.ring__avail_data_size;
    pub const size = __root.ring__size;
    pub const map_fd = __root.ring__map_fd;
...
pub const struct_user_ring_buffer = opaque {
    ...
    pub const reserve_blocking = __root.user_ring_buffer__reserve_blocking;
...
pub const struct_perf_buffer = opaque {
    ...
    pub const perf_buffer__epoll_fd = __root.perf_buffer__epoll_fd;
    ...
    pub const perf_buffer__buffer_cnt = __root.perf_buffer__buffer_cnt;
    pub const perf_buffer__buffer_fd = __root.perf_buffer__buffer_fd;
    pub const perf_buffer__buffer = __root.perf_buffer__buffer;
    pub const free = __root.perf_buffer__free;
    pub const epoll_fd = __root.perf_buffer__epoll_fd;
    pub const poll = __root.perf_buffer__poll;
    pub const consume = __root.perf_buffer__consume;
    pub const consume_buffer = __root.perf_buffer__consume_buffer;
    pub const buffer_cnt = __root.perf_buffer__buffer_cnt;
    pub const buffer_fd = __root.perf_buffer__buffer_fd;
    pub const buffer = __root.perf_buffer__buffer;
};
pub const perf_buffer_sample_fn = ?*const fn (ctx: ?*anyopaque, cpu: c_int, data: ?*anyopaque, size: __u32) callconv(.c) void;
pub const perf_buffer_lost_fn = ?*const fn (ctx: ?*anyopaque, cpu: c_int, cnt: __u64) callconv(.c) void; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
...
pub const perf_buffer_event_fn = ?*const fn (ctx: ?*anyopaque, cpu: c_int, event: ?*struct_perf_event_header) callconv(.c) enum_bpf_perf_event_ret; // /snap/zig/16206/lib/compiler/aro/include/stddef.h:3:2: warning: struct demoted to opaque type - has bitfield
...
pub const struct_bpf_prog_linfo = opaque {
    ...
    pub const bpf_prog_linfo__lfind_addr_func = __root.bpf_prog_linfo__lfind_addr_func;
    pub const bpf_prog_linfo__lfind = __root.bpf_prog_linfo__lfind;
    pub const free = __root.bpf_prog_linfo__free;
    pub const lfind_addr_func = __root.bpf_prog_linfo__lfind_addr_func;
    pub const lfind = __root.bpf_prog_linfo__lfind;
};
...
pub const struct_bpf_linker = opaque {
    ...
    pub const add_file = __root.bpf_linker__add_file;
...
pub const struct_sockaddr_xdp = extern struct {
    sxdp_family: __u16 = 0,
    sxdp_flags: __u16 = 0,
    sxdp_ifindex: __u32 = 0,
    sxdp_queue_id: __u32 = 0,
    sxdp_shared_umem_fd: __u32 = 0,
};
...
pub const struct_xdp_umem_reg = extern struct {
    ...
    headroom: __u32 = 0,
    flags: __u32 = 0,
    tx_metadata_len: __u32 = 0,
};
pub const struct_xdp_statistics = extern struct {
    rx_dropped: __u64 = 0,
    rx_invalid_descs: __u64 = 0,
    tx_invalid_descs: __u64 = 0,
    rx_ring_full: __u64 = 0,
    rx_fill_ring_empty_descs: __u64 = 0,
    tx_ring_empty_descs: __u64 = 0,
};
...
const struct_unnamed_104 = extern struct {
    tx_timestamp: __u64 = 0,
};
const union_unnamed_102 = extern union {
    request: struct_unnamed_103,
    completion: struct_unnamed_104,
};
pub const struct_xsk_tx_metadata = extern struct {
    flags: __u64 = 0,
...
pub const struct_xsk_ring_prod = extern struct {
    ...
    mask: __u32 = 0,
    size: __u32 = 0,
    producer: [*c]__u32 = null,
    consumer: [*c]__u32 = null,
    ring: ?*anyopaque = null,
    flags: [*c]__u32 = null,
    pub const xsk_ring_prod__fill_addr = __root.xsk_ring_prod__fill_addr;
    pub const xsk_ring_prod__tx_desc = __root.xsk_ring_prod__tx_desc;
    pub const xsk_ring_prod__needs_wakeup = __root.xsk_ring_prod__needs_wakeup;
    pub const xsk_ring_prod__reserve = __root.xsk_ring_prod__reserve;
    pub const fill_addr = __root.xsk_ring_prod__fill_addr;
    pub const tx_desc = __root.xsk_ring_prod__tx_desc;
    pub const needs_wakeup = __root.xsk_ring_prod__needs_wakeup;
    pub const reserve = __root.xsk_ring_prod__reserve;
};
pub const struct_xsk_ring_cons = extern struct {
    ...
    ring: ?*anyopaque = null,
    flags: [*c]__u32 = null,
    pub const xsk_ring_cons__comp_addr = __root.xsk_ring_cons__comp_addr;
    pub const xsk_ring_cons__rx_desc = __root.xsk_ring_cons__rx_desc;
    pub const xsk_ring_cons__peek = __root.xsk_ring_cons__peek;
    pub const xsk_ring_cons__cancel = __root.xsk_ring_cons__cancel;
    pub const comp_addr = __root.xsk_ring_cons__comp_addr;
    pub const rx_desc = __root.xsk_ring_cons__rx_desc;
    pub const peek = __root.xsk_ring_cons__peek;
    pub const cancel = __root.xsk_ring_cons__cancel;
};
pub const struct_xsk_umem = opaque {
    pub const xsk_umem__fd = __root.xsk_umem__fd;
    pub const xsk_umem__delete = __root.xsk_umem__delete;
    pub const fd = __root.xsk_umem__fd;
    pub const delete = __root.xsk_umem__delete;
};
pub const struct_xsk_socket = opaque {
    pub const xsk_socket__fd = __root.xsk_socket__fd;
    pub const xsk_socket__update_xskmap = __root.xsk_socket__update_xskmap;
    pub const xsk_socket__delete = __root.xsk_socket__delete;
    pub const fd = __root.xsk_socket__fd;
    pub const update_xskmap = __root.xsk_socket__update_xskmap;
    pub const delete = __root.xsk_socket__delete;
};
pub fn xsk_ring_prod__fill_addr(arg_fill: [*c]struct_xsk_ring_prod, arg_idx: __u32) callconv(.c) [*c]__u64 {
    var fill = arg_fill;
    _ = &fill;
    var idx = arg_idx;
    _ = &idx;
    var addrs: [*c]__u64 = @ptrCast(@alignCast(fill.*.ring));
    _ = &addrs;
    return &addrs[idx & fill.*.mask];
}
pub fn xsk_ring_cons__comp_addr(arg_comp: [*c]const struct_xsk_ring_cons, arg_idx: __u32) callconv(.c) [*c]const __u64 {
    var comp = arg_comp;
    _ = &comp;
    var idx = arg_idx;
    _ = &idx;
    var addrs: [*c]const __u64 = @ptrCast(@alignCast(comp.*.ring));
    _ = &addrs;
    return &addrs[idx & comp.*.mask];
}
pub fn xsk_ring_prod__tx_desc(arg_tx: [*c]struct_xsk_ring_prod, arg_idx: __u32) callconv(.c) [*c]struct_xdp_desc {
    var tx = arg_tx;
    _ = &tx;
    var idx = arg_idx;
    _ = &idx;
    var descs: [*c]struct_xdp_desc = @ptrCast(@alignCast(tx.*.ring));
    _ = &descs;
    return &descs[idx & tx.*.mask];
}
pub fn xsk_ring_cons__rx_desc(arg_rx: [*c]const struct_xsk_ring_cons, arg_idx: __u32) callconv(.c) [*c]const struct_xdp_desc {
    var rx = arg_rx;
    _ = &rx;
    var idx = arg_idx;
    _ = &idx;
    var descs: [*c]const struct_xdp_desc = @ptrCast(@alignCast(rx.*.ring));
    _ = &descs;
    return &descs[idx & rx.*.mask];
}
pub fn xsk_ring_prod__needs_wakeup(arg_r: [*c]const struct_xsk_ring_prod) callconv(.c) c_int {
    var r = arg_r;
    _ = &r;
    return @bitCast(@as(c_uint, @truncate(r.*.flags.* & @as(__u32, @bitCast(@as(c_int, @as(c_int, 1) << @intCast(@as(c_int, 0))))))));
} // /usr/include/xdp/xsk.h:106:19: warning: TODO implement function '__atomic_load_n' in std.zig.c_builtins
// /usr/include/xdp/xsk.h:92:25: warning: unable to translate function, demoted to extern
pub extern fn xsk_prod_nb_free(arg_r: [*c]struct_xsk_ring_prod, arg_nb: __u32) callconv(.c) __u32; // /usr/include/xdp/xsk.h:117:20: warning: TODO implement function '__atomic_load_n' in std.zig.c_builtins
// /usr/include/xdp/xsk.h:112:25: warning: unable to translate function, demoted to extern
pub extern fn xsk_cons_nb_avail(arg_r: [*c]struct_xsk_ring_cons, arg_nb: __u32) callconv(.c) __u32;
pub fn xsk_ring_prod__reserve(arg_prod: [*c]struct_xsk_ring_prod, arg_nb: __u32, arg_idx: [*c]__u32) callconv(.c) __u32 {
    var prod = arg_prod;
    _ = &prod;
    var nb = arg_nb;
    _ = &nb;
    ...
    prod.*.cached_prod +%= nb;
    return nb;
} // /usr/include/xdp/xsk.h:140:2: warning: TODO implement function '__atomic_store_n' in std.zig.c_builtins
// /usr/include/xdp/xsk.h:135:24: warning: unable to translate function, demoted to extern
pub extern fn xsk_ring_prod__submit(arg_prod: [*c]struct_xsk_ring_prod, arg_nb: __u32) callconv(.c) void;
pub fn xsk_ring_cons__peek(arg_cons: [*c]struct_xsk_ring_cons, arg_nb: __u32, arg_idx: [*c]__u32) callconv(.c) __u32 {
    var cons = arg_cons;
    _ = &cons;
    var nb = arg_nb;
    _ = &nb;
    ...
    _ = &entries;
    if (entries > @as(__u32, 0)) {
        idx.* = cons.*.cached_cons;
        cons.*.cached_cons +%= entries;
    }
    return entries;
}
pub fn xsk_ring_cons__cancel(arg_cons: [*c]struct_xsk_ring_cons, arg_nb: __u32) callconv(.c) void {
    var cons = arg_cons;
    _ = &cons;
    var nb = arg_nb;
    _ = &nb;
    cons.*.cached_cons -%= nb;
} // /usr/include/xdp/xsk.h:165:2: warning: TODO implement function '__atomic_store_n' in std.zig.c_builtins
// /usr/include/xdp/xsk.h:160:24: warning: unable to translate function, demoted to extern
pub extern fn xsk_ring_cons__release(arg_cons: [*c]struct_xsk_ring_cons, arg_nb: __u32) callconv(.c) void;
pub fn xsk_umem__get_data(arg_umem_area: ?*anyopaque, arg_addr: __u64) callconv(.c) ?*anyopaque {
    var umem_area = arg_umem_area;
    _ = &umem_area;
    var addr = arg_addr;
    _ = &addr;
    return @ptrCast(@alignCast(&@as([*c]u8, @ptrCast(@alignCast(umem_area)))[@intCast(addr)]));
}
pub fn xsk_umem__extract_addr(arg_addr: __u64) callconv(.c) __u64 {
    var addr = arg_addr;
    _ = &addr;
    return addr & ((@as(c_ulonglong, 1) << @intCast(@as(c_ulonglong, XSK_UNALIGNED_BUF_OFFSET_SHIFT))) -% @as(c_ulonglong, 1));
}
pub fn xsk_umem__extract_offset(arg_addr: __u64) callconv(.c) __u64 {
    var addr = arg_addr;
    _ = &addr;
    return addr >> @intCast(@as(__u64, XSK_UNALIGNED_BUF_OFFSET_SHIFT));
}
pub fn xsk_umem__add_offset_to_addr(arg_addr: __u64) callconv(.c) __u64 {
    var addr = arg_addr;
    _ = &addr;
...
pub const __INT64_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `L`"); // <builtin>:180:9
...
pub const __UINT32_FMTX__ = "X";
pub const __UINT32_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `U`"); // <builtin>:205:9
...
pub const __UINT64_FMTX__ = "lX";
pub const __UINT64_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `UL`"); // <builtin>:214:9
...
pub const __GLIBC_USE = @compileError("unable to translate macro: undefined identifier `__GLIBC_USE_`"); // /snap/zig/16206/lib/libc/include/generic-glibc/features.h:197:9
...
pub const __glibc_has_attribute = @compileError("unable to translate macro: undefined identifier `__has_attribute`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:45:10
pub inline fn __glibc_has_builtin(name: anytype) @TypeOf(__builtin.has_builtin(name)) {
    _ = &name;
    return __builtin.has_builtin(name);
}
pub const __glibc_has_extension = @compileError("unable to translate macro: undefined identifier `__has_extension`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:55:10
pub const __LEAF = @compileError("unable to translate macro: undefined identifier `__leaf__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:65:11
pub const __LEAF_ATTR = @compileError("unable to translate macro: undefined identifier `__leaf__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:66:11
pub const __THROW = @compileError("unable to translate macro: undefined identifier `__nothrow__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:79:11
pub const __THROWNL = @compileError("unable to translate macro: undefined identifier `__nothrow__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:80:11
pub const __NTH = @compileError("unable to translate macro: undefined identifier `__nothrow__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:81:11
pub const __NTHNL = @compileError("unable to translate macro: undefined identifier `__nothrow__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:82:11
pub const __COLD = @compileError("unable to translate macro: undefined identifier `__cold__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:102:11
...
pub const __CONCAT = @compileError("unable to translate C expr: unexpected token '##'"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:131:9
pub const __STRING = @compileError("unable to translate C expr: unexpected token ''"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:132:9
...
pub const __warnattr = @compileError("unable to translate macro: undefined identifier `__warning__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:366:10
pub const __errordecl = @compileError("unable to translate macro: undefined identifier `__error__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:367:10
pub const __flexarr = @compileError("unable to translate C expr: unexpected token '['"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:379:10
pub const __glibc_c99_flexarr_available = @as(c_int, 1);
pub const __REDIRECT = @compileError("unable to translate C expr: unexpected token '__asm__'"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:410:10
pub const __REDIRECT_NTH = @compileError("unable to translate C expr: unexpected token '__asm__'"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:417:11
pub const __REDIRECT_NTHNL = @compileError("unable to translate C expr: unexpected token '__asm__'"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:419:11
pub const __ASMNAME = @compileError("unable to translate macro: undefined identifier `__USER_LABEL_PREFIX__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:422:10
...
pub const __attribute_malloc__ = @compileError("unable to translate macro: undefined identifier `__malloc__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:452:10
pub const __attribute_alloc_size__ = @compileError("unable to translate macro: undefined identifier `__alloc_size__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:460:10
pub const __attribute_alloc_align__ = @compileError("unable to translate macro: undefined identifier `__alloc_align__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:469:10
pub const __attribute_pure__ = @compileError("unable to translate macro: undefined identifier `__pure__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:479:10
pub const __attribute_const__ = @compileError("unable to translate C expr: unexpected token '__attribute__'"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:486:10
pub const __attribute_maybe_unused__ = @compileError("unable to translate macro: undefined identifier `__unused__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:492:10
pub const __attribute_used__ = @compileError("unable to translate macro: undefined identifier `__used__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:501:10
pub const __attribute_noinline__ = @compileError("unable to translate macro: undefined identifier `__noinline__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:502:10
pub const __attribute_deprecated__ = @compileError("unable to translate macro: undefined identifier `__deprecated__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:510:10
pub const __attribute_deprecated_msg__ = @compileError("unable to translate macro: undefined identifier `__deprecated__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:520:10
pub const __attribute_format_arg__ = @compileError("unable to translate macro: undefined identifier `__format_arg__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:533:10
pub const __attribute_format_strfmon__ = @compileError("unable to translate macro: undefined identifier `__format__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:543:10
pub const __attribute_nonnull__ = @compileError("unable to translate macro: undefined identifier `__nonnull__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:555:11
pub inline fn __nonnull(params: anytype) @TypeOf(__attribute_nonnull__(params)) {
    _ = &params;
    return __attribute_nonnull__(params);
}
pub const __returns_nonnull = @compileError("unable to translate macro: undefined identifier `__returns_nonnull__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:568:10
pub const __attribute_warn_unused_result__ = @compileError("unable to translate macro: undefined identifier `__warn_unused_result__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:577:10
pub const __wur = "";
pub const __always_inline = @compileError("unable to translate macro: undefined identifier `__always_inline__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:595:10
pub const __attribute_artificial__ = @compileError("unable to translate macro: undefined identifier `__artificial__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:604:10
pub const __extern_inline = @compileError("unable to translate C expr: unexpected token 'extern'"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:626:11
pub const __extern_always_inline = @compileError("unable to translate C expr: unexpected token 'extern'"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:627:11
pub const __fortify_function = __extern_always_inline ++ __attribute_artificial__;
pub const __va_arg_pack = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg_pack`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:638:10
pub const __va_arg_pack_len = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg_pack_len`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:639:10
pub const __restrict_arr = @compileError("unable to translate C expr: unexpected token '__restrict'"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:666:10
...
pub const __glibc_macro_warning1 = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:807:10
pub const __glibc_macro_warning = @compileError("unable to translate macro: undefined identifier `GCC`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:808:10
pub const __HAVE_GENERIC_SELECTION = @as(c_int, 1);
pub const __glibc_const_generic = @compileError("unable to translate C expr: expected type instead got 'const'"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:837:10
...
pub const __attribute_returns_twice__ = @compileError("unable to translate macro: undefined identifier `__returns_twice__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:884:10
pub const __attribute_struct_may_alias__ = @compileError("unable to translate macro: undefined identifier `__may_alias__`"); // /snap/zig/16206/lib/libc/include/generic-glibc/sys/cdefs.h:893:10
...
pub const offsetof = @compileError("unable to translate macro: undefined identifier `__builtin_offsetof`"); // /snap/zig/16206/lib/compiler/aro/include/stddef.h:18:9
pub const __need___va_list = "";
pub const __STDC_VERSION_STDARG_H__ = @as(c_int, 0);
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /snap/zig/16206/lib/compiler/aro/include/stdarg.h:12:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /snap/zig/16206/lib/compiler/aro/include/stdarg.h:14:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /snap/zig/16206/lib/compiler/aro/include/stdarg.h:15:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /snap/zig/16206/lib/compiler/aro/include/stdarg.h:18:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /snap/zig/16206/lib/compiler/aro/include/stdarg.h:22:9
...
pub const __FSID_T_TYPE = @compileError("unable to translate macro: undefined identifier `__val`"); // /snap/zig/16206/lib/libc/include/x86-linux-gnu/bits/typesizes.h:73:9
...
pub const __getc_unlocked_body = @compileError("TODO postfix inc/dec expr"); // /snap/zig/16206/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:113:9
pub const __putc_unlocked_body = @compileError("TODO postfix inc/dec expr"); // /snap/zig/16206/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:117:9
...
pub const __f128 = @compileError("unable to translate macro: undefined identifier `f128`"); // /snap/zig/16206/lib/libc/include/x86-linux-gnu/bits/floatn.h:72:12
pub const __CFLOAT128 = @compileError("unable to translate: invalid numeric type"); // /snap/zig/16206/lib/libc/include/x86-linux-gnu/bits/floatn.h:86:12
...
pub const __f32 = @compileError("unable to translate macro: undefined identifier `f32`"); // /snap/zig/16206/lib/libc/include/generic-glibc/bits/floatn-common.h:93:12
pub const __f64 = @compileError("unable to translate macro: undefined identifier `f64`"); // /snap/zig/16206/lib/libc/include/generic-glibc/bits/floatn-common.h:105:12
pub const __f32x = @compileError("unable to translate macro: undefined identifier `f32x`"); // /snap/zig/16206/lib/libc/include/generic-glibc/bits/floatn-common.h:113:12
pub const __f64x = @compileError("unable to translate macro: undefined identifier `f64x`"); // /snap/zig/16206/lib/libc/include/generic-glibc/bits/floatn-common.h:125:12
pub const __CFLOAT32 = @compileError("unable to translate: invalid numeric type"); // /snap/zig/16206/lib/libc/include/generic-glibc/bits/floatn-common.h:151:12
pub const __CFLOAT64 = @compileError("unable to translate: invalid numeric type"); // /snap/zig/16206/lib/libc/include/generic-glibc/bits/floatn-common.h:163:12
pub const __CFLOAT32X = @compileError("unable to translate: invalid numeric type"); // /snap/zig/16206/lib/libc/include/generic-glibc/bits/floatn-common.h:171:12
pub const __CFLOAT64X = @compileError("unable to translate: invalid numeric type"); // /snap/zig/16206/lib/libc/include/generic-glibc/bits/floatn-common.h:183:12
...
pub const __FD_ZERO = @compileError("unable to translate macro: undefined identifier `__i`"); // /snap/zig/16206/lib/libc/include/generic-glibc/bits/select.h:25:9
pub const __FD_SET = @compileError("unable to translate C expr: expected ')' instead got '|='"); // /snap/zig/16206/lib/libc/include/generic-glibc/bits/select.h:32:9
pub const __FD_CLR = @compileError("unable to translate C expr: expected ')' instead got '&='"); // /snap/zig/16206/lib/libc/include/generic-glibc/bits/select.h:34:9
...
pub const __PTHREAD_MUTEX_INITIALIZER = @compileError("unable to translate C expr: unexpected token '{'"); // /snap/zig/16206/lib/libc/include/x86-linux-gnu/bits/struct_mutex.h:55:10
...
pub const __ONCE_FLAG_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // /snap/zig/16206/lib/libc/include/generic-glibc/bits/thread-shared-types.h:114:9
...
pub const __struct_group = @compileError("unable to translate C expr: unexpected token 'union'"); // /snap/zig/16206/lib/libc/include/any-linux-any/linux/stddef.h:32:9
pub const __DECLARE_FLEX_ARRAY = @compileError("unable to translate macro: undefined identifier `__empty_`"); // /snap/zig/16206/lib/libc/include/any-linux-any/linux/stddef.h:53:9
...
pub const __aligned_u64 = @compileError("unable to translate macro: undefined identifier `aligned`"); // /snap/zig/16206/lib/libc/include/any-linux-any/linux/types.h:50:9
pub const __aligned_s64 = @compileError("unable to translate macro: undefined identifier `aligned`"); // /snap/zig/16206/lib/libc/include/any-linux-any/linux/types.h:51:9
pub const __aligned_be64 = @compileError("unable to translate macro: undefined identifier `aligned`"); // /snap/zig/16206/lib/libc/include/any-linux-any/linux/types.h:52:9
pub const __aligned_le64 = @compileError("unable to translate macro: undefined identifier `aligned`"); // /snap/zig/16206/lib/libc/include/any-linux-any/linux/types.h:53:9
...
pub const ___BPF_FUNC_MAPPER = @compileError("unable to translate macro: undefined identifier `unspec`"); // /snap/zig/16206/lib/libc/include/any-linux-any/linux/bpf.h:5902:9
pub const __BPF_FUNC_MAPPER_APPLY = @compileError("unable to translate C expr: unexpected token ''"); // /snap/zig/16206/lib/libc/include/any-linux-any/linux/bpf.h:6123:9
...
pub const __bpf_md_ptr = @compileError("unable to translate macro: undefined identifier `aligned`"); // /snap/zig/16206/lib/libc/include/any-linux-any/linux/bpf.h:6314:9
...
pub const bpf_object_open_opts__last_field = @compileError("unable to translate macro: undefined identifier `kernel_log_level`"); // /usr/include/bpf/libbpf.h:183:9
pub const bpf_object__for_each_program = @compileError("unable to translate C expr: unexpected token 'for'"); // /usr/include/bpf/libbpf.h:297:9
pub const bpf_perf_event_opts__last_field = @compileError("unable to translate macro: undefined identifier `force_ioctl_attach`"); // /usr/include/bpf/libbpf.h:461:9
pub const bpf_kprobe_opts__last_field = @compileError("unable to translate macro: undefined identifier `attach_mode`"); // /usr/include/bpf/libbpf.h:500:9
pub const bpf_kprobe_multi_opts__last_field = @compileError("unable to translate macro: undefined identifier `retprobe`"); // /usr/include/bpf/libbpf.h:526:9
pub const bpf_uprobe_multi_opts__last_field = @compileError("unable to translate macro: undefined identifier `retprobe`"); // /usr/include/bpf/libbpf.h:551:9
pub const bpf_ksyscall_opts__last_field = @compileError("unable to translate macro: undefined identifier `retprobe`"); // /usr/include/bpf/libbpf.h:593:9
pub const bpf_uprobe_opts__last_field = @compileError("unable to translate macro: undefined identifier `attach_mode`"); // /usr/include/bpf/libbpf.h:653:9
pub const bpf_usdt_opts__last_field = @compileError("unable to translate macro: undefined identifier `usdt_cookie`"); // /usr/include/bpf/libbpf.h:702:9
pub const bpf_tracepoint_opts__last_field = @compileError("unable to translate macro: undefined identifier `bpf_cookie`"); // /usr/include/bpf/libbpf.h:732:9
pub const bpf_trace_opts__last_field = @compileError("unable to translate macro: undefined identifier `cookie`"); // /usr/include/bpf/libbpf.h:754:9
pub const bpf_netfilter_opts__last_field = @compileError("unable to translate macro: undefined identifier `flags`"); // /usr/include/bpf/libbpf.h:782:9
pub const bpf_tcx_opts__last_field = @compileError("unable to translate macro: undefined identifier `expected_revision`"); // /usr/include/bpf/libbpf.h:797:9
pub const bpf_netkit_opts__last_field = @compileError("unable to translate macro: undefined identifier `expected_revision`"); // /usr/include/bpf/libbpf.h:812:9
pub const bpf_iter_attach_opts__last_field = @compileError("unable to translate macro: undefined identifier `link_info_len`"); // /usr/include/bpf/libbpf.h:828:9
pub const bpf_object__for_each_map = @compileError("unable to translate C expr: unexpected token 'for'"); // /usr/include/bpf/libbpf.h:913:9
pub const bpf_map__for_each = bpf_object__for_each_map;
pub const bpf_xdp_set_link_opts__last_field = @compileError("unable to translate macro: undefined identifier `old_fd`"); // /usr/include/bpf/libbpf.h:1173:9
pub const bpf_xdp_attach_opts__last_field = @compileError("unable to translate macro: undefined identifier `old_prog_fd`"); // /usr/include/bpf/libbpf.h:1180:9
pub const bpf_xdp_query_opts__last_field = @compileError("unable to translate macro: undefined identifier `xdp_zc_max_segs`"); // /usr/include/bpf/libbpf.h:1193:9
...
pub const bpf_tc_hook__last_field = @compileError("unable to translate macro: undefined identifier `parent`"); // /usr/include/bpf/libbpf.h:1223:9
pub const bpf_tc_opts__last_field = @compileError("unable to translate macro: undefined identifier `priority`"); // /usr/include/bpf/libbpf.h:1234:9
pub const ring_buffer_opts__last_field = @compileError("unable to translate macro: undefined identifier `sz`"); // /usr/include/bpf/libbpf.h:1256:9
pub const user_ring_buffer_opts__last_field = @compileError("unable to translate macro: undefined identifier `sz`"); // /usr/include/bpf/libbpf.h:1344:9
pub const perf_buffer_opts__last_field = @compileError("unable to translate macro: undefined identifier `sample_period`"); // /usr/include/bpf/libbpf.h:1465:9
pub const perf_buffer_raw_opts__last_field = @compileError("unable to translate macro: undefined identifier `map_keys`"); // /usr/include/bpf/libbpf.h:1509:9
pub const gen_loader_opts__last_field = @compileError("unable to translate macro: undefined identifier `insns_sz`"); // /usr/include/bpf/libbpf.h:1697:9
pub const bpf_linker_opts__last_field = @compileError("unable to translate macro: undefined identifier `sz`"); // /usr/include/bpf/libbpf.h:1711:9
pub const bpf_linker_file_opts__last_field = @compileError("unable to translate macro: undefined identifier `sz`"); // /usr/include/bpf/libbpf.h:1717:9
pub const libbpf_prog_handler_opts__last_field = @compileError("unable to translate macro: undefined identifier `prog_attach_fn`"); // /usr/include/bpf/libbpf.h:1780:9
...
pub const XDP_USE_SG = @as(c_int, 1) << @as(c_int, 4);
pub const XDP_UMEM_UNALIGNED_CHUNK_FLAG = @as(c_int, 1) << @as(c_int, 0);
pub const XDP_UMEM_TX_SW_CSUM = @as(c_int, 1) << @as(c_int, 1);
pub const XDP_UMEM_TX_METADATA_LEN = @as(c_int, 1) << @as(c_int, 2);
...
pub const XDP_MAX_TX_SKB_BUDGET = @as(c_int, 9);
pub const XDP_OPTIONS_ZEROCOPY = @as(c_int, 1) << @as(c_int, 0);
pub const XDP_PGOFF_RX_RING = @as(c_int, 0);
pub const XDP_PGOFF_TX_RING = __helpers.promoteIntLiteral(c_int, 0x80000000, .hex);
...
pub const XDP_TXMD_FLAGS_TIMESTAMP = @as(c_int, 1) << @as(c_int, 0);
pub const XDP_TXMD_FLAGS_CHECKSUM = @as(c_int, 1) << @as(c_int, 1);
pub const XDP_TXMD_FLAGS_LAUNCH_TIME = @as(c_int, 1) << @as(c_int, 2);
pub const XDP_PKT_CONTD = @as(c_int, 1) << @as(c_int, 0);
pub const XDP_TX_METADATA = @as(c_int, 1) << @as(c_int, 1);
pub const XDP_ALWAYS_INLINE = @compileError("unable to translate C expr: unexpected token 'static'"); // /usr/include/xdp/xsk.h:29:9
pub const DEFINE_XSK_RING = @compileError("unable to translate macro: untranslatable usage of arg `name`"); // /usr/include/xdp/xsk.h:33:9
...
pub const bpf_task_work = struct_bpf_task_work;
...
pub const bpf_insn_array_value = struct_bpf_insn_array_value;
...
pub const xsk_tx_metadata = struct_xsk_tx_metadata;
