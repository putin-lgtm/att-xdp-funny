...
pub const struct_rtnl_link_stats = extern struct {
    rx_packets: __u32 = @import("std").mem.zeroes(__u32),
    tx_packets: __u32 = @import("std").mem.zeroes(__u32),
    rx_bytes: __u32 = @import("std").mem.zeroes(__u32),
    tx_bytes: __u32 = @import("std").mem.zeroes(__u32),
    rx_errors: __u32 = @import("std").mem.zeroes(__u32),
    tx_errors: __u32 = @import("std").mem.zeroes(__u32),
    rx_dropped: __u32 = @import("std").mem.zeroes(__u32),
    tx_dropped: __u32 = @import("std").mem.zeroes(__u32),
    multicast: __u32 = @import("std").mem.zeroes(__u32),
    collisions: __u32 = @import("std").mem.zeroes(__u32),
    rx_length_errors: __u32 = @import("std").mem.zeroes(__u32),
    rx_over_errors: __u32 = @import("std").mem.zeroes(__u32),
    rx_crc_errors: __u32 = @import("std").mem.zeroes(__u32),
    rx_frame_errors: __u32 = @import("std").mem.zeroes(__u32),
    rx_fifo_errors: __u32 = @import("std").mem.zeroes(__u32),
    rx_missed_errors: __u32 = @import("std").mem.zeroes(__u32),
    tx_aborted_errors: __u32 = @import("std").mem.zeroes(__u32),
    tx_carrier_errors: __u32 = @import("std").mem.zeroes(__u32),
    tx_fifo_errors: __u32 = @import("std").mem.zeroes(__u32),
    tx_heartbeat_errors: __u32 = @import("std").mem.zeroes(__u32),
    tx_window_errors: __u32 = @import("std").mem.zeroes(__u32),
    rx_compressed: __u32 = @import("std").mem.zeroes(__u32),
    tx_compressed: __u32 = @import("std").mem.zeroes(__u32),
    rx_nohandler: __u32 = @import("std").mem.zeroes(__u32),
};
pub const struct_rtnl_link_stats64 = extern struct {
    rx_packets: __u64 = @import("std").mem.zeroes(__u64),
    tx_packets: __u64 = @import("std").mem.zeroes(__u64),
    rx_bytes: __u64 = @import("std").mem.zeroes(__u64),
    tx_bytes: __u64 = @import("std").mem.zeroes(__u64),
    rx_errors: __u64 = @import("std").mem.zeroes(__u64),
    tx_errors: __u64 = @import("std").mem.zeroes(__u64),
    rx_dropped: __u64 = @import("std").mem.zeroes(__u64),
    tx_dropped: __u64 = @import("std").mem.zeroes(__u64),
    multicast: __u64 = @import("std").mem.zeroes(__u64),
    collisions: __u64 = @import("std").mem.zeroes(__u64),
    rx_length_errors: __u64 = @import("std").mem.zeroes(__u64),
    rx_over_errors: __u64 = @import("std").mem.zeroes(__u64),
    rx_crc_errors: __u64 = @import("std").mem.zeroes(__u64),
    rx_frame_errors: __u64 = @import("std").mem.zeroes(__u64),
    rx_fifo_errors: __u64 = @import("std").mem.zeroes(__u64),
    rx_missed_errors: __u64 = @import("std").mem.zeroes(__u64),
    tx_aborted_errors: __u64 = @import("std").mem.zeroes(__u64),
    tx_carrier_errors: __u64 = @import("std").mem.zeroes(__u64),
    tx_fifo_errors: __u64 = @import("std").mem.zeroes(__u64),
    tx_heartbeat_errors: __u64 = @import("std").mem.zeroes(__u64),
    tx_window_errors: __u64 = @import("std").mem.zeroes(__u64),
    rx_compressed: __u64 = @import("std").mem.zeroes(__u64),
    tx_compressed: __u64 = @import("std").mem.zeroes(__u64),
    rx_nohandler: __u64 = @import("std").mem.zeroes(__u64),
    rx_otherhost_dropped: __u64 = @import("std").mem.zeroes(__u64),
};
...
pub const struct_rtnl_link_ifmap = extern struct {
    mem_start: __u64 = @import("std").mem.zeroes(__u64),
    mem_end: __u64 = @import("std").mem.zeroes(__u64),
    base_addr: __u64 = @import("std").mem.zeroes(__u64),
    irq: __u16 = @import("std").mem.zeroes(__u16),
    dma: __u8 = @import("std").mem.zeroes(__u8),
    port: __u8 = @import("std").mem.zeroes(__u8),
};
...
pub const IFLA_TSO_MAX_SIZE: c_int = 59;
pub const IFLA_TSO_MAX_SEGS: c_int = 60;
pub const IFLA_ALLMULTI: c_int = 61;
pub const IFLA_DEVLINK_PORT: c_int = 62;
pub const IFLA_GSO_IPV4_MAX_SIZE: c_int = 63;
pub const IFLA_GRO_IPV4_MAX_SIZE: c_int = 64;
pub const __IFLA_MAX: c_int = 65;
...
pub const struct_ifla_bridge_id = extern struct {
    prio: [2]__u8 = @import("std").mem.zeroes([2]__u8),
    addr: [6]__u8 = @import("std").mem.zeroes([6]__u8),
};
...
pub const IFLA_BRPORT_MAB: c_int = 40;
pub const IFLA_BRPORT_MCAST_N_GROUPS: c_int = 41;
pub const IFLA_BRPORT_MCAST_MAX_GROUPS: c_int = 42;
pub const __IFLA_BRPORT_MAX: c_int = 43;
const enum_unnamed_133 = c_uint;
pub const struct_ifla_cacheinfo = extern struct {
    max_reasm_len: __u32 = @import("std").mem.zeroes(__u32),
    tstamp: __u32 = @import("std").mem.zeroes(__u32),
    reachable_time: __u32 = @import("std").mem.zeroes(__u32),
    retrans_time: __u32 = @import("std").mem.zeroes(__u32),
};
...
pub const struct_ifla_vlan_qos_mapping = extern struct {
    from: __u32 = @import("std").mem.zeroes(__u32),
    to: __u32 = @import("std").mem.zeroes(__u32),
};
...
pub const IFLA_XFRM_COLLECT_METADATA: c_int = 3;
pub const __IFLA_XFRM_MAX: c_int = 4;
...
pub const struct_tunnel_msg = extern struct {
    ...
    reserved2: __u16 = @import("std").mem.zeroes(__u16),
    ifindex: __u32 = @import("std").mem.zeroes(__u32),
};
...
pub const struct_ifla_vxlan_port_range = extern struct {
    low: __be16 = @import("std").mem.zeroes(__be16),
    high: __be16 = @import("std").mem.zeroes(__be16),
};
...
pub const IFLA_BOND_SLAVE_PRIO: c_int = 9;
pub const __IFLA_BOND_SLAVE_MAX: c_int = 10;
...
pub const struct_ifla_vf_mac = extern struct {
    vf: __u32 = @import("std").mem.zeroes(__u32),
    mac: [32]__u8 = @import("std").mem.zeroes([32]__u8),
};
pub const struct_ifla_vf_broadcast = extern struct {
    broadcast: [32]__u8 = @import("std").mem.zeroes([32]__u8),
};
pub const struct_ifla_vf_vlan = extern struct {
    vf: __u32 = @import("std").mem.zeroes(__u32),
    vlan: __u32 = @import("std").mem.zeroes(__u32),
    qos: __u32 = @import("std").mem.zeroes(__u32),
};
...
pub const struct_ifla_vf_vlan_info = extern struct {
    ...
    vlan: __u32 = @import("std").mem.zeroes(__u32),
    qos: __u32 = @import("std").mem.zeroes(__u32),
    vlan_proto: __be16 = @import("std").mem.zeroes(__be16),
};
pub const struct_ifla_vf_tx_rate = extern struct {
    vf: __u32 = @import("std").mem.zeroes(__u32),
    rate: __u32 = @import("std").mem.zeroes(__u32),
};
pub const struct_ifla_vf_rate = extern struct {
    vf: __u32 = @import("std").mem.zeroes(__u32),
    min_tx_rate: __u32 = @import("std").mem.zeroes(__u32),
    max_tx_rate: __u32 = @import("std").mem.zeroes(__u32),
};
pub const struct_ifla_vf_spoofchk = extern struct {
    vf: __u32 = @import("std").mem.zeroes(__u32),
    setting: __u32 = @import("std").mem.zeroes(__u32),
};
pub const struct_ifla_vf_guid = extern struct {
    vf: __u32 = @import("std").mem.zeroes(__u32),
    guid: __u64 = @import("std").mem.zeroes(__u64),
};
...
pub const struct_ifla_vf_link_state = extern struct {
    vf: __u32 = @import("std").mem.zeroes(__u32),
    link_state: __u32 = @import("std").mem.zeroes(__u32),
};
...
pub const struct_ifla_port_vsi = extern struct {
    vsi_mgr_id: __u8 = @import("std").mem.zeroes(__u8),
    vsi_type_id: [3]__u8 = @import("std").mem.zeroes([3]__u8),
    vsi_type_version: __u8 = @import("std").mem.zeroes(__u8),
...
pub const struct_if_stats_msg = extern struct {
    family: __u8 = @import("std").mem.zeroes(__u8),
    pad1: __u8 = @import("std").mem.zeroes(__u8),
    pad2: __u16 = @import("std").mem.zeroes(__u16),
    ifindex: __u32 = @import("std").mem.zeroes(__u32),
    filter_mask: __u32 = @import("std").mem.zeroes(__u32),
};
...
pub const IFLA_DSA_UNSPEC: c_int = 0;
pub const IFLA_DSA_MASTER: c_int = 1;
pub const __IFLA_DSA_MAX: c_int = 2;
...
const union_unnamed_183 = extern union {
    ifu_broadaddr: struct_sockaddr,
    ifu_dstaddr: struct_sockaddr,
};
pub const struct_iface_184 = opaque {};
pub const struct_ifaddr = extern struct {
    ifa_addr: struct_sockaddr = @import("std").mem.zeroes(struct_sockaddr),
    ifa_ifu: union_unnamed_183 = @import("std").mem.zeroes(union_unnamed_183),
    ifa_ifp: ?*struct_iface_184 = @import("std").mem.zeroes(?*struct_iface_184),
...
pub const struct_ifreq = extern struct {
    ifr_ifrn: union_unnamed_185 = @import("std").mem.zeroes(union_unnamed_185),
    ifr_ifru: union_unnamed_186 = @import("std").mem.zeroes(union_unnamed_186),
};
...
pub const struct_ifconf = extern struct {
    ...
    ifc_ifcu: union_unnamed_187 = @import("std").mem.zeroes(union_unnamed_187),
};
...
pub const __AC = @compileError("unable to translate C expr: expected ')' instead got '##'");
// /home/putin/zig-linux-x86_64-0.13.0/lib/libc/include/any-linux-any/linux/const.h:20:9
...
pub const _UL = @compileError("unable to translate macro: undefined identifier `UL`");
// /home/putin/zig-linux-x86_64-0.13.0/lib/libc/include/any-linux-any/linux/const.h:25:9
pub const _ULL = @compileError("unable to translate macro: undefined identifier `ULL`");
// /home/putin/zig-linux-x86_64-0.13.0/lib/libc/include/any-linux-any/linux/const.h:26:9
...
pub const __ALIGN_KERNEL = @compileError("unable to translate C expr: unexpected token '__typeof__'");
// /home/putin/zig-linux-x86_64-0.13.0/lib/libc/include/any-linux-any/linux/const.h:31:9
...
pub const NLMSG_NEXT = @compileError("unable to translate C expr: expected ')' instead got '-='");
// /home/putin/zig-linux-x86_64-0.13.0/lib/libc/include/any-linux-any/linux/netlink.h:104:9
...
pub const IFLA_RTA = @compileError("unable to translate macro: undefined identifier `rtattr`");
// /home/putin/zig-linux-x86_64-0.13.0/lib/libc/include/any-linux-any/linux/if_link.h:396:9
pub const IFLA_PAYLOAD = @compileError("unable to translate macro: undefined identifier `ifinfomsg`");
// /home/putin/zig-linux-x86_64-0.13.0/lib/libc/include/any-linux-any/linux/if_link.h:397:9
...
pub const IFLA_DSA_MAX = __IFLA_DSA_MAX - @as(c_int, 1);
